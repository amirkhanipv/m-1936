...
import { Heart, Dumbbell, Waves, Utensils, Wine, Coffee, Clock, Car, Plane, MapPin, Users, Music, BookOpen, Camera } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Heart key={0} />, <Dumbbell key={1} />, <Waves key={2} />, <Camera key={3} />],
